class UpdateFitenessProfileModel {
  UpdateFitenessProfileModel({
  ...
  UpdateFitenessProfileModel.fromJson(Map<String, dynamic> json){
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json){
    ...
    print("the data from json middle");
    facebookId = null;
    googleId = null;
    ...
    address = null;
    postal = null;
    print("the data from json full middle");
...
class MyNotifications {
  ...
  MyNotifications.fromJson(Map<String, dynamic> json){
    print("print notification 1st");
    id = json['id'];
    ///
    print("print notification 2st");
    userId = json['user_id'];
    print("print notification 3st");
