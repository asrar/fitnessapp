...
class UserService {
  static Future<bool> browse(String query) async {
    ...
    if (query != null && query.isNotEmpty) {
      _url = 'https://yfitness.com/fitness/public/api/login?${query}';
    ...
    if (response.statusCode != 200) {
      ...
      try {
        ...
        if (response.statusCode != 200) {
          ...
          Overseer.userName = _userList[0].Data1.firstName+" "+_userList[0].Data1.lastName;
          Overseer.userId = _userList[0].Data1.id;
          print("Over seer User ID ${Overseer.userId} Sign In User ID ${_userList[0].Data1.id}");
