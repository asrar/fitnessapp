...
class GetCatagoryCoursesService {
  static Future<List<GetCatagoryCoursesModel>> browse() async {
    ...
    List<GetCatagoryCoursesModel> _mainList =
    collection.map((json) => GetCatagoryCoursesModel.fromJson(json)).toList();
